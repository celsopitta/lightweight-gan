...
from lightweight_gan.dino_discriminator import  HybridDINOv2Discriminator, DINOv2Discriminator
    ...
    def __init__(
        ...
        *,
        ...
        if use_dinov2_discriminator:
            if use_hybrid_discriminator:
                # Use Hybrid CNN + DINOv2 Discriminator
                self.D = HybridDINOv2Discriminator(
                    image_size = image_size,
                    fmap_max = fmap_max,
                    fmap_inverse_coef = fmap_inverse_coef,
                    transparent = transparent,
                ...
                # Use pure DINOv2 Discriminator
                self.D = DINOv2Discriminator(
                    image_size = image_size,
                    fmap_max = fmap_max,
                    fmap_inverse_coef = fmap_inverse_coef,
                    transparent = transparent,
                    ...
                    pool_patch_tokens = 'mean',
                )
        else:
            # Use original CNN discriminator
            self.D = Discriminator(
                image_size = image_size,
                fmap_max = fmap_max,
                fmap_inverse_coef = fmap_inverse_coef,
...
class Trainer():
    def __init__(
        ...
        **kwargs
            ...
            # Store DINOv2 parameters
        self.use_dinov2_discriminator = use_dinov2_discriminator
        self.dino_model_name = dino_model_name
        self.freeze_dino = freeze_dino
        self.use_hybrid_discriminator = use_hybrid_discriminator
